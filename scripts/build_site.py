...
for name in ['site-data.json','ais_disabling_events_2017_2026.csv.gz','ais_disabling_events_atlantico.csv','monthly.csv','context-analysis.json','context-monthly.csv','context-periods.csv']:
